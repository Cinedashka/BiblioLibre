...
# Styling
style = ttk.Style()
style.configure("TButton", background="#FF6B6B", foreground="#000000")
style.configure("TLabel", background="#F4F4F4", foreground="#000000")
style.configure("TEntry", background="#FFFFFF", fieldbackground="#000000")
...
def afficher_livres():
    ...
    result_label.configure(text="Les informations ont été récupérées avec succès depuis la base de données 'bibliotheque.db'.")

# Input Form
input_frame = tk.Frame(root, bg="#F4F4F4")
input_label = ttk.Label(input_frame, text="Nouveau Livre", font=("Helvetica", 16), background="#F4F4F4", foreground="#000000")

input_label.pack(pady=5)
result_label = ttk.Label(input_frame, text="", background="#F4F4F4" , foreground="#000000")
result_label.pack()

titre_label = ttk.Label(input_frame, text="Titre:", background="#F4F4F4" , foreground="#000000")
titre_label.pack()
entry_titre = ttk.Entry(input_frame)
entry_titre.pack()

annee_label = ttk.Label(input_frame, text="Annee d'edition:", background="#F4F4F4" , foreground="#000000" )
annee_label.pack()
entry_annee = ttk.Entry(input_frame)
entry_annee.pack()

exemplaire_label = ttk.Label(input_frame, text="Nombre d'exemplaires:", background="#F4F4F4" , foreground="#000000")
exemplaire_label.pack()
entry_exemplaires = ttk.Entry(input_frame)
entry_exemplaires.pack()

nom_label = ttk.Label(input_frame, text="Nom de l'auteur:", background="#F4F4F4" , foreground="#000000")
nom_label.pack()
entry_nom_auteur = ttk.Entry(input_frame)
entry_nom_auteur.pack()

prenom_label = ttk.Label(input_frame, text="Prenom de l'auteur:", background="#F4F4F4" , foreground="#000000")
prenom_label.pack()
...
display_label = ttk.Label(display_frame, text="Livres enregistrées", font=("Helvetica", 16), background="#F4F4F4" , foreground="#000000")
